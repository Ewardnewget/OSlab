...
//const char* rootfs = "/home/pkusei/share/lxc/ubuntu1/rootfs"; 
const char* rootfs = "/var/lib/lxc/ubuntu3/rootfs/"; 
//container 主机名
...
struct cgroup*  cgroup_control(pid_t pid){
    ...
    //限制只能使用0和1号cpu
    if (  cgroup_add_value_uint64(cgc_memory, "memory.limit_in_bytes", MEMORY_LIMIT) ){
